			...
			<!--Slide part Ends -->
				...
				<div id="content_area">
						...
						<div id="products_box">
							...
							$run_products = $con->query("select * from products where product_title like '%$search_query%'");
									while($row_products=mysqli_fetch_assoc($run_products)){
											...
											echo "													
												<div id='single_product'>
													<h4 id='gameHomePAgeTitle'><a href='view.php?product_id=$product_id' style='float:left;color: white;'>$product_title</a></h4>
